...
class TimeUtils:
    ...
    def begin_of_day_mills(cls, day=None):
        ...
        try:
            ...
            return int(cls.get_seconds(dt.date(day_u.year, day_u.month, day_u.day)) * 1000)
        except AttributeError:
            pass
        except Exception as e:
            print(e)
    ...
    def end_of_day_mills(cls, day=None):
        ...
        """
        try:
            return int(cls.begin_of_day_mills(day) + 24 * 60 * 60 * 1000 - 1)
        except TypeError:
            pass
        except Exception as e:
            print(e)
    ...
    def get_month_end_day(year: int, month: int) -> int:
        ...
        while days:
            try:
                dt.date(year=year, month=month, day=days)
                return days
            except ValueError:
                days -= 1
    ...
    @classmethod
    def is_zero_time(cls, timestamp):
        date_str = TimeUtils.get_format_time(timestamp)
        return cls.begin_of_day_mills(date_str) == timestamp
